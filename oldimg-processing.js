...
function insertPhoto(path,num){
		...
		stringstuff+= "<style=\"float:left;position:relative;left:400px;display:none\">";
...
$(document).ready(function(){ //Apparently this line is bad code hurr - to fix, put script in <head> and call <div> before.
